// ============================================
// Image Generation Routes - Prompts & Images
// Uses OpenRouter for prompt generation
// Uses Runware WebSocket for image generation
// ============================================
...
// Generate prompts for scenes using OpenRouter
// ============================================

router.post(
  '/vps/imagem/gerarPrompts',
  authenticateApiKey,
