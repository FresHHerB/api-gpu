...
import { OpenRouterRequest, OpenRouterResponse, OpenRouterMessage } from '../../shared/types';
...
export class OpenRouterService {
  ...
  constructor() {
    this.timeout = parseInt(process.env.IMAGE_GENERATION_TIMEOUT || '120000', 10);
    this.apiKey = process.env.OPENROUTER_API_KEY || '';
    this.model = process.env.OPENROUTER_MODEL || 'google/gemini-2.0-flash';
      ...
      const response: AxiosResponse<OpenRouterResponse> = await axios.post(
        ...
        requestData,
        {
          headers: {
            ...
            'HTTP-Referer': process.env.HTTP_REFERER || 'https://api-gpu.automear.com',
            'X-Title': 'API GPU - Image Generation'
          },
